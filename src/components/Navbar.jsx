        ...
        >
            <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
                ...
                >
                    ...
                    >
                        <FontAwesomeIcon icon={faHouse} className='text-[25px] cursor-pointer hover:text-[#facc15]' />
                ...
                <ul className='list-none hidden sm:flex flex-row gap-3'>
                    {navLinks.map((Link) => (
                        <li key={Link.id} 
                            ...
                            className =
                            {`${ active === Link.title ? "" : "hover:text-white/70" }
                            hover:text-[#facc15] relative text-[18px] text-[#facc15] font-medium cursor-pointer rounded-full px-3 py-1 outline-2 outline-teal-100 transition focus-visible:outline`} 
