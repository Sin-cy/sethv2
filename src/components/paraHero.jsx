...
const ParaHero = () => {
    ...
    return (
        <section className=" relative w-full h-screen mx-auto mt-20 ">
            <h1
                className={`${styles.heroHeadText} text-[#facc15] absolute z-20 w-full text-center`}
                style={{ top: "35%", transform: "translateY(-50%)" }}
            >
                {/* <TextScramble duration={2} speed={0.05} > */}
                <TextScramble
                    speed={0.05}
                    trigger={isTrigger}
                    onHoverStart={() => {
            ...
            <div className="parallax">
                <img
                    className="parallax_heroMainBg"
                    src="./pv3/herobgfinal.png"
                    alt=""
                />
                ...
                <img
                    className="parallax_baserock"
                    src="./pv3/baserock.png"
                    alt=""
                />
                <img
                    className="parallax_toprock"
                    src="./pv3/toprock.png"
                    alt=""
                />
                <img
                    className="parallax_character"
                    src="./pv3/character.png"
                    alt=""
                />
                <img
                    className="parallax_haloring"
                    src="./pv3/haloring.png"
                    alt=""
                />
            </div>
